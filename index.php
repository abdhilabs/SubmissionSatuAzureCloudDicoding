<html>
 ...
 <?php
    $host = "submissionsatu.database.windows.net";
    $user = "abdhi";
    $pass = "riza!?462199";
    $db = "submissionsatu";

    try {
        $conn = new PDO("sqlsrv:server = tcp:submissionsatu.database.windows.net,1433; Database = DaftarPondok", "abdhi", "riza!?462199");
